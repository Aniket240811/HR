...
def predict():
    ...
    if request.method == 'POST':
        ...
        if(JobRole_Human_Resources=='Human_Resources'):
        ...
        elif(JobRole_Laboratory_Technician=='Laboratory_Technician'):
            ...
            JobRole_Sales_Executive=0
            JobRole_Sales_Representative=0    
        elif(JobRole_Manufacturing_Director=='Manufacturing_Director'):
            JobRole_Human_Resources=0
            JobRole_Laboratory_Technician=0
            JobRole_Manager=0
            ...
            JobRole_Sales_Executive=0
            JobRole_Sales_Representative=0
        elif(JobRole_Research_Director=='Research_Director'):
            JobRole_Human_Resources=0
            JobRole_Laboratory_Technician=0
            JobRole_Manager=0
            JobRole_Manufacturing_Director=0
            ...
            JobRole_Sales_Executive=0
            JobRole_Sales_Representative=0
        elif(JobRole_Research_Scientist=='Research_Scientist'):
            JobRole_Human_Resources=0
            JobRole_Laboratory_Technician=0
            JobRole_Manager=0
            JobRole_Manufacturing_Director=0
            ...
            JobRole_Sales_Executive=0
            JobRole_Sales_Representative=0
        elif(JobRole_Sales_Executive=='Sales_Executive'):
            JobRole_Human_Resources=0
            JobRole_Laboratory_Technician=0
            JobRole_Manager=0
            JobRole_Manufacturing_Director=0
            ...
            JobRole_Sales_Representative=0    
        elif(JobRole_Sales_Representative=='Sales_Representative'):
            JobRole_Human_Resources=0
            JobRole_Laboratory_Technician=0
            JobRole_Manager=0
            JobRole_Manufacturing_Director=0
        ...
        if(BusinessTravel_Travel_Frequently=='Travel_Frequently'):
                ...
                BusinessTravel_Travel_Rarely=0
        elif(BusinessTravel_Travel_Rarely=='Travel_Rarely'):
        ...
        if(MaritalStatus_Married=='Married'):
                ...
                MaritalStatus_Single=0
        elif(MaritalStatus_Single=='Single'):
        ...
        prediction=model.predict([[Age,Department_Research_Development,Department_Sales,
                                   ...
                                   MonthlyIncome,PercentSalaryHike,OverTime,DistanceFromHome,StockOptionLevel,
                                   MaritalStatus_Married,MaritalStatus_Single,TrainingTimesLastYear,YearsSinceLastPromotion,
                                   JobLevel,YearsWithCurrManager,Total_Satisfaction]])
